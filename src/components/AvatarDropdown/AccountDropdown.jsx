...
export default function AccountDropdown({ user, onLogout, onDeleteAccount }) {
  ...
  return (
    <div className="account-dropdown">
      <button className="account-dropdown__button" onClick={toggleDropdown}>
      ...
      {isOpen && (
        <div className="account-dropdown__menu">
          <button className="account-dropdown__item">View/Edit Profile</button>
